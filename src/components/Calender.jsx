...
const Calender = () => {
  return (
    <div>
      <h2 className="text-[#222222] text-2xl sm:text-3xl md:text-7xl text-center font-serif mt-10 sm:mt-16 drop-shadow-[0_0_10px_rgba(255,0,0,0.8)] [text-shadow:1px_1px_0_red,-1px_-1px_0_red,1px_-1px_0_red,-1px_1px_0_red]">
        Mark Your Calender
      </h2>
      <div
      ...
      <div className="flex items-center justify-center mt-6 md:mt-8 text-white overflow-x-auto px-4">
        <div className="flex flex-nowrap items-center justify-center gap-7 md:space-x-8 lg:space-x-10 sm:mt-10 md:mt-15 ">
...
function Timebox(props) {
  return (
    <div className="flex flex-col items-center">
      <div className="bg-gray-200 text-black rounded-md shadow-[0_0_15px_#ff0000aa] w-16 h-20 md:w-24 md:h-28 lg:w-32 lg:h-40 flex items-center justify-center text-xl md:text-6xl font-bold hover:scale-110 hover:shadow-[0_0_30px_#ff0000dd] cursor-pointer">
        {props.value}
      </div>
